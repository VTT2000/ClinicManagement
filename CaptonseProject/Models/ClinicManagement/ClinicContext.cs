...
public partial class ClinicContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AppointmentId).HasName("PK__Appointm__8ECDFCA2735BAADE");
        ...
        {
            entity.HasKey(e => e.BillId).HasName("PK__Bills__11F2FC4A2CE45F40");
            ...
            entity.HasOne(d => d.Appointment).WithMany(p => p.Bills)
                ...
                .HasConstraintName("FK__Bills__Appointme__440B1D61");
        });
        ...
        {
            entity.HasKey(e => e.DiagnosisId).HasName("PK__Diagnose__0C54CB93A69FE3C7");
            ...
            entity.HasOne(d => d.Appointment).WithMany(p => p.Diagnoses)
                .HasForeignKey(d => d.AppointmentId)
                .HasConstraintName("FK__Diagnoses__Appoi__44FF419A");
        });

        modelBuilder.Entity<Doctor>(entity =>
        {
            entity.HasKey(e => e.DoctorId).HasName("PK__Doctors__2DC00EDF6DF5B3E1");

            entity.HasIndex(e => e.UserId, "UQ__Doctors__1788CCADF473811A").IsUnique();
            ...
            entity.HasOne(d => d.User).WithOne(p => p.Doctor)
                ...
                .HasConstraintName("FK__Doctors__UserID__49C3F6B7");
        });

        modelBuilder.Entity<Medicine>(entity =>
        {
            entity.HasKey(e => e.MedicineId).HasName("PK__Medicine__4F2128F0AA9F7179");
        ...
        {
            entity.HasKey(e => e.PatientId).HasName("PK__Patients__970EC346D984F7F0");

            entity.HasIndex(e => e.UserId, "UQ__Patients__1788CCAD371507FA").IsUnique();
            ...
            entity.HasOne(d => d.User).WithOne(p => p.Patient)
                ...
                .HasConstraintName("FK__Patients__UserID__4AB81AF0");
        });

        modelBuilder.Entity<Prescription>(entity =>
        {
            entity.HasKey(e => e.PrescriptionId).HasName("PK__Prescrip__40130812B36F7A71");
        ...
        {
            entity.HasKey(e => e.RoomId).HasName("PK__Room__32863919088D09EB");
        ...
        {
            entity.HasKey(e => e.ServiceId).HasName("PK__Services__C51BB0EA3DD11DA4");
            ...
            entity.HasOne(d => d.ServiceParent).WithMany(p => p.InverseServiceParent)
                ...
                .HasConstraintName("FK__Services__Servic__4E88ABD4");
        });

        modelBuilder.Entity<User>(entity =>
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCAC82D22A25");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D10534FCA1BB30").IsUnique();
        ...
        {
            entity.HasKey(e => e.WorkScheduleId).HasName("PK__WorkSche__C6AC635EB3FF4824");
